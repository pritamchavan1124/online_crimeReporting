 ...
 const [isLoading, setLoading] = useState(true);
  ...
  const [entireComplaint,setEntireComplaint]=useState()
    ...
    const getFurtherDetails=(complaintId)=>{
      ...
      axios.get(config.serverURL+'/api/policestation/complaint/details/'+complaintId,{
    ...
    getFurtherDetails(complaintId);
     ...
     return (
        ...
        <div className="container" style={{ height:menuHeight}}>           
                ...
                <Button onClick={()=>navigateBack(entireComplaint.regComplaint.policeStation.id)} title='Back'/>
                </div>
        </div>
     )
}
...
export default PsComplaintDetails